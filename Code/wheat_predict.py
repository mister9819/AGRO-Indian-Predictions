...
dataset = pd.read_excel(r"Final Dataset Wheat.xlsx")[:n1]
...
plt.plot(X_test.iloc[:, 1][:20], y_pred[:20], label='RandomForestRegressor')
plt.title('Wheat January 2015 actual vs predictions')
plt.xlabel('State')
